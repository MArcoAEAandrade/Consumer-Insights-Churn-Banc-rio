...
Ao adicionarmoruma lupa na carteira Bronze, observa-se que a maior parte dos clientes que permanece no banco, no grupo de baixo risco representam (**76,6% da base**) o que é positivo. Entretanto, os clientes de baixo risco que cancelam representam **15,8% da carteira**,referencianciando a pareto se trata dos 15% que é respisvem por 97% . apresentando saldo médio e score de crédito significativamente menores que os clientes de mesmo perfil que permanecem ativos. Nos segmentos classificados como maior risco, tanto os que permanecem quanto cancelados apresentam redução adicional de renda e score, indicando que a evasão está fortemente associada aos clientes de menor capital financeiro e menor capacidade de crédito.
